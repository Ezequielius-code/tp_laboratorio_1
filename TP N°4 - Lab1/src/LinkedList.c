...
int ll_contains(LinkedList* this,void* pElement)
{
    ...
    if(this != NULL && ll_indexOf(this,pElement) != -1)
    {
    	returnAux = 1;
    }
    else
    {
    	if(this != NULL && ll_indexOf(this,pElement) < 0)
    	{
    		returnAux = 0;
    	}
    }
...
/**
 * \brief Aplica una función a toda la LinkedList.
 * \param this Puntero a LinkedList.
 * \param fn Función a aplicar recibida.
 * \return Retorna la LinkedList modificada por la función.
 *
 */
