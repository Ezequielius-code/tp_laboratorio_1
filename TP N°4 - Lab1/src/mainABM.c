/*
 ============================================================================
 Name        : TrabajoPrácticoN°4-Laboratorio1.c
...
int main()
{
    ...
    snprintf(menu,sizeof(menu),"\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c MENU %c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c"
    		                   ...
    		                   "\n   10. Aumentar sueldos mayores a $20000.-"
    		                   "\n   11. Salir"
    ...
    do
    {
    	...
    	switch(opcion)
        {
            ...
            break;
            case 10:
            	if(controller_raiseSalary(listaEmpleados))
            	{
            		printf("\nSe ha producido un error.");
            	}
            	else
            	{
            		printf("\nLos sueldos se han incrementado exitosamente.");
            	}
        }
    }while(opcion != 11);
